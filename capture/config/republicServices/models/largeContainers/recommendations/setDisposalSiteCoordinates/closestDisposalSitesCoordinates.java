...
//returnLocations = numberOfClosestDisposalSites_l; //Specifies number of closest locations that we are interested in - default 3
returnLocations = 0; 
...
/*
liftsPerContainerDict = dict("float");
put(liftsPerContainerDict, "1/Week", 1.0);
put(liftsPerContainerDict, "2/Week", 2.0);
put(liftsPerContainerDict, "3/Week", 3.0);
put(liftsPerContainerDict, "4/Week", 4.0);
put(liftsPerContainerDict, "5/Week", 5.0);
put(liftsPerContainerDict, "6/Week", 6.0);
put(liftsPerContainerDict, "7/Week", 7.0);
put(liftsPerContainerDict, "EOW", 0.5);
put(liftsPerContainerDict, "Every 4 Weeks", 0.25);*/
//frequencyConversionResultSet = bmql("SELECT Frequency, conversionFactor FROM Frequency_Conversion WHERE Frequency = $haulsPerPeriod");
