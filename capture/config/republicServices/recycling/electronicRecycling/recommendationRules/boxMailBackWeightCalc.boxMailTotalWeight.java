...
Updates:    20152108 - Mark Egeland - #710 Update to handle weight less than smallest box limit.
=====================================================================================================
*/
...
lastWeight = 0;
count = 1;
lastArrayValue = sizeofarray(orderedLimits);
for each in orderedLimits{
	...
	if(count == lastArrayValue AND remainingWeight > 0){
		if(containskey(boxQtyDict, each)){
			put(boxQtyDict, each, get(boxQtyDict, each) + 1);
		}else{
			put(boxQtyDict, each, 1);
		}
	}
