...
if(customerRateRestriction_quote == True){
	if(yr_1_text == "" OR isnumber(yr_1_text)==True OR yr_1_text == "CPI"){
		if(yr_2_text == "" OR isnumber(yr_2_text)==True OR yr_2_text == "CPI"){
			if(yr_3_text == "" OR isnumber(yr_3_text)==True OR yr_3_text == "CPI"){
				if(yr_4_text == "" OR isnumber(yr_4_text)==True OR yr_4_text == "CPI"){
					return false;
				}	
			}
		}	
