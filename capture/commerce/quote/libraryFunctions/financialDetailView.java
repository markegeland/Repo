...
if(isExistingCustomer){
	returnStr = returnStr + "<td align=\"center\" >" + formatascurrency(total_OpIncome_After, "USD") + "</td>"
						  + "<td align=\"center\" >" + formatascurrency(total_OpIncome_Before, "USD") + "</td>"
						  + "<td align=\"center\" >" + formatascurrency(total_OpIncome_Variance, "USD") + "</td>";
}
...
if(isExistingCustomer){
	returnStr = returnStr + "<td align=\"center\" >" + string(round(total_Margin_Percent_After, 2))+ "%</td>"
						  + "<td align=\"center\" >" + string(round(total_Margin_Percent_Before, 2)) + "%</td>"
						  + "<td align=\"center\" >" + string(round(total_Margin_Percent_Variance, 2)) + "%</td>";
}
