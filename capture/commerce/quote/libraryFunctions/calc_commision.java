...
Updates:    
        20141229 - John Palubinskas - initialize large cont dictionaries to prevent RTE when doing a get on a dictionary that doesn't contain the key.  Looping fix.
...
// Populate the modelNameDict
for line in line_process{
    if(line._part_number == ""){
        // model
        if(not(containskey(modelNameDict, line._document_number))){
            put(modelNameDict, line._document_number, line._model_name);
        }
    }
}
